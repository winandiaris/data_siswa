	 ...
	 <body>
        ...
        <div class="container">
            ...
            <div class="codrops-top">
				...
				<h3 align = "center"><b>IDENTITAS PESERTA DIDIK</b></h3><br><br>           
	<div align="center">
	<b><font color="black" size="2" face="verdana"><?php //include "./include/waktu.php"; ?>
		...
		<td>
			...
			<td ><?php echo ":&nbsp; ";?> </td>
			<td width="375"><font face="arial" color = "black" ><?php echo  stripslashes($row[2]);?></font></td>
			</tr>
			...
			<td width="277" align="justify"><font face="arial" size="2" color="black"><?php echo  $row[75];?></font></td>
			</tr>
